...
const { safeRe: re, safeSrc: src, t } = __webpack_require__(/*! ../internal/re */ "./node_modules/conf/node_modules/semver/internal/re.js")
...
const createHockeyWindow = () => {
    ...
    hockeyWindow = new electron_1.BrowserWindow({
        width: 400,
        height: 600,
        frame: false,
        transparent: true,
...
electron_1.ipcMain.handle('get-github-token', () => {
    return store.get('github-token');
});
electron_1.ipcMain.handle('set-github-token', (_, token) => {
